...
potential_tasks = {
    ...
    "UsersAndGroups": [
            "Add a sudo user 'baipesho', use the 'wheel' group",
            "Add two users 'pesho' and 'gosho', make one of them member of 'wheel' group",
            "Create user 'vieri' and set his password to 'hello', make it changable on each 90 days",
    ...
    "Logging": [
            ...
            "Log a message called 'Attention' to rsyslog using 'logger', check the generic log file for its appearance",
    ...
    "SSH": [
            ...
            "Create a user 'ganio' and generate ssh keys for him"
    ],

    "NFSandSamba": [
            "Export /nfs/share to 192.168.0.1, make sure people could write to it",
            "Export samba share with label [SambaShare] under path=/samba/share, make it browsable, allow guest acceptance."
    ],
